<%@ Page Title="" Language="C#" MasterPageFile="~/CoolBizMasterPage.Master" AutoEventWireup="true" CodeBehind="frmPersonnel.aspx.cs" Inherits="CIS407Project.WebForm3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" Height="250px" HorizontalAlign="Left" Width="300px">
        ...
        <asp:Button ID="btnSubmit" runat="server" Text="Submit" PostBackUrl="~/frmPersonalVerified.aspx" />
        <!--Not in the instructions. I added this button to clear the 5 text boxes so that people could start over without leaving and coming back-->
