<%@ Page Title="Salary Calculator" Language="C#" MasterPageFile="~/CoolBizMasterPage.Master" AutoEventWireup="true" CodeBehind="frmSalaryCalculator.aspx.cs" Inherits="CIS407Project.frmSalaryCalculator" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="frmSalaryCalculatorInput" runat="server">
